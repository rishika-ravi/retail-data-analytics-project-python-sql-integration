...
This project demonstrates a solid understanding of the data analytics lifecycle, from raw data to actionable insights. It showcases strong technical skills, attention to detail, and the ability to work with multiple tools and technologies - all essential for a career in data analytics.
...
**LinkedIn:** https://www.linkedin.com/in/rishika-ravi-kukuttala

**Email:** rishika.ravi0@gmail.com

**<h3>About the Maintainer</h3>**
This project is currently maintained by RISHIKA RAVI KUKUTTALA, a Data Analyst with 3+ years of professional experience in data analytics, visualization, and data pipeline development. Rishika is skilled in Python, SQL, and Power BI, with a strong background in statistical analysis and KPI-driven reporting. She is dedicated to transforming complex data into actionable insights and improving operational efficiency.